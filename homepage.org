...
If setup when the VM is built, the following sesame 2.8 tools and 
access points are also available:
    ...
    - [[http://localhost:8080/openrdf-workbench/repositories/unifiedviews][Unifiedviews Repository]]
